...
## Testing the Limits
The `goodreadsfaker` module in this project (legacy name) generates fake data which is used to test the ETL pipeline on heavy load.  
...
DAG Run Results:
![TopReads DAG Run](docs/images/DAG_tree_view.PNG)

Data Loaded to Warehouse:
![TopReads Warehouse Count](docs/images/WarehouseCount.PNG)
