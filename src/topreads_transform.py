...
class TopReadsTransform:
    ...
    def transform_author_dataset(self):
        ...
        deduped_author_df = author_df\
                            ...
                            .withColumn('name', topreads_udf.remove_extra_spaces('name'))
    ...
    def transform_reviews_dataset(self):
        ...
        deduped_reviews_df = deduped_reviews_df \
            .withColumn('review_added_date', topreads_udf.stringtodatetime('review_added_date')) \
            .withColumn('review_updated_date', topreads_udf.stringtodatetime('review_updated_date'))
