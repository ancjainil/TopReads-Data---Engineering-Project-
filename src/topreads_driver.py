...
from topreads_transform import TopReadsTransform
from s3_module import TopReadsS3Module
from pathlib import Path
import logging
import logging.config
import configparser
from warehouse.topreads_warehouse_driver import TopReadsWarehouseDriver
import time
...
def create_sparksession():
    ...
    """
    return SparkSession.builder.master('yarn').appName("topreads") \
...
def main():
    ...
    grwarehouse = TopReadsWarehouseDriver()
