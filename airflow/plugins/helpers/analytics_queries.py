class AnalyticsQueries:
    ...
    create_schema = """CREATE SCHEMA IF NOT EXISTS topreads_analytics;"""

    create_author_reviews = """
        CREATE TABLE IF NOT EXISTS topreads_analytics.popular_authors_review_count
        (
    ...
    create_author_rating = """
        CREATE TABLE IF NOT EXISTS topreads_analytics.popular_authors_average_rating
        (
            author_id BIGINT PRIMARY KEY DISTKEY,
    ...
    create_best_authors = """
        CREATE TABLE IF NOT EXISTS topreads_analytics.best_authors
        (
            author_id BIGINT PRIMARY KEY DISTKEY,
            review_count BIGINT,
            average_review_rating FLOAT,
    ...
    populate_authors_reviews = """
        INSERT INTO topreads_analytics.popular_authors_review_count
        ...
        FROM
        topreads_warehouse.reviews as re
        where re.record_create_timestamp > '{0}' and re.record_create_timestamp < '{1}'
        group by re.author_id
        order by review_count desc
        ) a
        inner join topreads_warehouse.authors b
        ON a.author_id = b.author_id
        ;
    """

    populate_authors_ratings = """
        INSERT INTO topreads_analytics.popular_authors_average_rating
    ...
    populate_best_authors = """
        INSERT INTO topreads_analytics.best_authors
        ...
        FROM topreads_analytics.popular_authors_average_rating ar
        INNER JOIN
        topreads_analytics.popular_authors_review_count rc
    ...
    create_book_reviews = """
        CREATE TABLE IF NOT EXISTS topreads_analytics.popular_books_review_count
        (
    ...
    create_book_rating = """
        CREATE TABLE IF NOT EXISTS topreads_analytics.popular_books_average_rating
        (
            book_id BIGINT PRIMARY KEY,
    ...
    create_best_books = """
        CREATE TABLE IF NOT EXISTS topreads_analytics.best_books
        (
            book_id BIGINT PRIMARY KEY,
    ...
    populate_books_reviews = """
        INSERT INTO topreads_analytics.popular_books_review_count
        ...
        inner join topreads_warehouse.books b
    ...
    populate_books_ratings = """
        INSERT INTO topreads_analytics.popular_books_average_rating
    ...
    populate_best_books = """
        INSERT INTO topreads_analytics.best_books
        ...
        FROM topreads_analytics.popular_books_average_rating ar
        INNER JOIN
        topreads_analytics.popular_books_review_count rc
